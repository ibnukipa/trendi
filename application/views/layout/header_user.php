...
<section>
	<div class="kotak-m tooltipped" data-position="right" data-delay="50" data-tooltip="Male's Fashion">
		  <a href="indextrendm.html"><img src="<?php echo base_url()?>assets/img/male_white.png" style=""></a>
	</div>
	<div class="kotak-f tooltipped" style="top: 20%; right: 0" data-position="left" data-delay="50" data-tooltip="Female's Fashion">
        <a href="indextrend.html"><img src="<?php echo base_url()?>assets/img/female_white.png" style=""></a>
	</div>
</section>    
    
    
<div id="logo" class="container">
	<a href="indexa.html"><img src="<?php echo base_url()?>assets/img/trendy.png" height="100" alt=""/></a>
	<!--<h1><a href="#" class="icon icon-spinner"><span>SquareAway</span></a></h1>-->
</div>
<div id="header">
	<div id="menu" class="container">
		<ul>
			<li class="current_page_item"><a href="indextrend.html" accesskey="1" title="">Trend</a></li>
			<li><a href="indexb.html" accesskey="1" title="">Season</a></li>
