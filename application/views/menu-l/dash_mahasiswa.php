<ul class="collapsible bayangan_2dp" data-collapsible="accordion" style="border: none">
    <li class="nama-menu">
        <div class="collapsible-header" style="border: none; background-color: <?php echo $warna_ketiga ?>; color: white; font-weight: 500">
            Dashboard menu
        </div>
    </li>
    <li>
    ...
    <li>
        <div class="collapsible-header">
            <a style="color: <?php echo $warna_utama ?>" href="#!">
                <i class="material-icons left">book</i>
                <i class="material-icons hide-on-small-only right change_icon" style="margin: 0"></i>
                <span style="font-weight: 500">Sidang</span>
            </a>
        </div>
        <div class="collapsible-body">
    ...
    <li>
        <div class="collapsible-header">
            <a style="color: <?php echo $warna_utama ?>" href="#!">
                <i class="material-icons left">book</i>
                <i class="material-icons hide-on-small-only right change_icon" style="margin: 0"></i>
                <span style="font-weight: 500">Progress TA</span>
            </a>
        </div>
        <div class="collapsible-body">
