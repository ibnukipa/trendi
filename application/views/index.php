...
<div id="logo" class="container">
	<img src="<?php echo base_url()?>assets/img/trendy.png" height="100" alt=""/>
...
<!--	<div id="banner" class="container"><a href="#"><img src="images/pic06.jpg" width="1200" height="300" alt="" /></a></div>-->
    <div id="banner" class="col-lg-3 "><a href="indextrend.html"><img src="<?php echo base_url()?>assets/img/aa.png" style="width:100%" alt="" /></a></div>
    <div id="banner" class="col-lg-3 "><a href="indextrend.html"><img src="<?php echo base_url()?>assets/img/ca.png" style="width:100%"  alt="" /></a></div>
    <div id="banner" class="col-lg-3"><a href="indextrendm.html"><img src="<?php echo base_url()?>assets/img/da.png" style="width:100%"  alt="" /></a></div>
    <div id="banner" class="col-lg-3 "><a href="indextrendm.html"><img src="<?php echo base_url()?>assets/img/ba.png" style="width:100%" alt="" /></a></div>
</div>
<div id="copyright">
